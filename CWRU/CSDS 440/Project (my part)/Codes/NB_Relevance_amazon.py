from parseData_amazon import create_dataset
import numpy as np
import os
...
def cal_model_v2(training_filename, training_size, testing_size):
    ...
    return y1_prob, y0_prob, prior_knowledge, training_data_table, testing_data_table
def cal_model_v3(training_filename, training_size, testing_size):
    training_data_table, testing_data_table = create_dataset(training_filename, training_size, testing_size)
    y1_count = 0
    y0_count = 0
    for i in range(len(training_data_table)-1):
    ...
    for i in range(int(len(score_list))):
        if score_list[i][1] > 10.83:
            del prior_knowledge[score_list[i][0]]
    return y1_prob, y0_prob, prior_knowledge, training_data_table, testing_data_table
def cal_model_v4(training_filename, training_size, testing_size):
    training_data_table, testing_data_table = create_dataset(training_filename, training_size, testing_size)
    y1_count = 0
    y0_count = 0
    for i in range(len(training_data_table)-1):
...
def NB_relevant_NB_retraining_v3_fs_1(training_filename, training_size, testing_size, training_filename_transfer, training_size_transfer, testing_size_transfer):
    # pre-trained model
    ...
    print('accuracy_relevant_transfer: ', accuracy_relevant_transfer)
    return accuracy_original, accuracy_transfer, accuracy_relevant_transfer
def NB_relevant_NB_retraining_v3_fs_2(training_filename, training_size, testing_size, training_filename_transfer, training_size_transfer, testing_size_transfer):
    # pre-trained model
    y1_prob, y0_prob, prior_knowledge, training_data_table, testing_data_table = cal_model_v3(training_filename, training_size, testing_size)
    print('Pre-model is built')
...
def NB_relevant_NB_retraining_v3_model(training_filenames, training_size, testing_size, training_filenames_transfer, training_size_transfer, testing_size_transfer):
    # pre-trained model
    y1_prob, y0_prob, prior_knowledge, training_data_table, testing_data_table = cal_model(training_filenames[0], training_size, testing_size)
    print('Pre-model is built')
    
    i = 1
    while i < len(training_filenames):
        # the current small model
        y1_prob_transfer, y0_prob_transfer, prior_knowledge_transfer, training_data_table_transfer, testing_data_table_transfer = cal_model(training_filenames[i], training_size, testing_size)
        print('Target-model is built')
    ...
    i = 0
    while i < len(training_filenames_transfer):        
        print('Round ', i)
        # the current small model
        y1_prob_transfer, y0_prob_transfer, prior_knowledge_transfer, training_data_table_transfer, testing_data_table_transfer = cal_model(training_filenames_transfer[i], training_size_transfer, testing_size_transfer)
        print('Target-model is built')
...
def NB_relevant_NB_retraining_v5(training_filename, training_size, testing_size, training_filename_transfer, training_size_transfer, testing_size_transfer):
    ...
    print('accuracy_relevant_transfer: ', accuracy_relevant_transfer)
    return accuracy_original, accuracy_transfer, accuracy_relevant_transfer
def NB_relevant_NB_retraining_v5_fs_1(training_filename, training_size, testing_size, training_filename_transfer, training_size_transfer, testing_size_transfer):
    # pre-trained model
    y1_prob, y0_prob, prior_knowledge, training_data_table, testing_data_table = cal_model_v2(training_filename, training_size, testing_size)
    print('Pre-model is built')
    ...
    print('accuracy_relevant_transfer: ', accuracy_relevant_transfer)
    return accuracy_original, accuracy_transfer, accuracy_relevant_transfer
def NB_relevant_NB_retraining_v5_fs_2(training_filename, training_size, testing_size, training_filename_transfer, training_size_transfer, testing_size_transfer):
    # pre-trained model
    y1_prob, y0_prob, prior_knowledge, training_data_table, testing_data_table = cal_model_v3(training_filename, training_size, testing_size)
    print('Pre-model is built')
    ...
    print('accuracy_relevant_transfer: ', accuracy_relevant_transfer)
    return accuracy_original, accuracy_transfer, accuracy_relevant_transfer
def NB_relevant_NB_retraining_v5_fs_3(training_filename, training_size, testing_size, training_filename_transfer, training_size_transfer, testing_size_transfer):
    # pre-trained model
    y1_prob, y0_prob, prior_knowledge, training_data_table, testing_data_table = cal_model_v4(training_filename, training_size, testing_size)
    print('Pre-model is built')
